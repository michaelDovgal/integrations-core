...
class Projects(BaseModel):
    ...
    exclude: Optional[Sequence[str]] = None
    include: Optional[Sequence[IncludeItem]] = None
...
class InstanceConfig(BaseModel):
    ...
    global_build_configs_exclude: Optional[Sequence[str]] = None
    global_build_configs_include: Optional[Sequence[str]] = None
